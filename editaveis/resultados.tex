...
\subsection{Atual Panorama}
  ...
  O módulo Controlador central possui um \texit{Raspberry PI}, utilizado para processar as informações submetidas a ele pelo módulo Joystick, e enviar as informações processadas para o módulo Motor. Isto é possivel graças ao software implementado. Nesta implementação foi utilizada o protocolo de comunicação UART.
...
\subsection{Controlador Central}
  ...
  A comunicação, tanto entre o MSP do Joystick e o \texit{Raspberry PI}, quanto entre o MSP do Motor e o \texit{Raspberry PI}, estão sendo feitas via \textit{threads}.
