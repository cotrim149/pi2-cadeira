...
\section{Controle}
Especificação de tecnologia: estudo e escolha da melhor tecnologia voltada para o problema. Estudo de qual tipo de controlador de potência a ser usado no motor, para controle de sua corrente
